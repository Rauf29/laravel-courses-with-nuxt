            ...
            <div class="border-b border-gray-200 py-6">
              ...
              <div class="pt-6">
                <div class="space-y-2">
                  ...
                  <div class="flex items-center">
                    <input
                        id="filter-price-membership"
                        value="membership"
                        type="checkbox"
                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                    <label
                        for="filter-price-membership"
                        class="ml-3 text-sm text-gray-600"
                    >
                      Paid (Membership)
                      <span class="text-xs text-gray-500">(9)</span>
                ...
                <div class="space-y-2">
                  <div class="flex items-center">
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Laracasts <span class="text-xs text-gray-500">(4)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
                  ...
                  <div class="flex items-center">
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Codecourse <span class="text-xs text-gray-500">(4)</span>
                    </label>
                  </div>
                </div>
              </div>
                ...
                <div class="space-y-2">
                  <div class="flex items-center">
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Laravel <span class="text-xs text-gray-500">(18)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      PHP <span class="text-xs text-gray-500">(1)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Livewire <span class="text-xs text-gray-500">(1)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Vue.js <span class="text-xs text-gray-500">(1)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
                    ...
                    <label
                        ...
                        class="ml-3 text-sm text-gray-600"
                    >
                      Alpine.js <span class="text-xs text-gray-500">(1)</span>
                    </label>
                  </div>
                  <div class="flex items-center">
                    <input
              ...
              <li class="bg-white px-4 py-6 shadow rounded-sm">
                <div class="flex justify-center">
                  ...
                  <div class="w-10/12">
                    <div class="flex">
                      <div class="flex-1 overflow-flex-wrap">
                        <h2 class="text-xl font-bold text-gray-900 mb-1">
                          ...
                          >Laravel Core Adventures</NuxtLink
                          >
                        </h2>
                    ...
                    <div
                        class="mt-4 space-y-1 text-sm text-gray-700 line-clamp-5"
                    >
                      <p>
                        A video course for every Laravel developer who wants to
                        know how Laravel works under the hood to become more
                    ...
                    <div class="mt-6">
                      <div class="flex flex-col">
                        <div
                            class="flex space-x-0 gap-2 flex-wrap justify-items-start"
                        >
                          <div
